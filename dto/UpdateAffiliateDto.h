...
#ifndef GNPAPI_UPDATEAFFILIATEDTO_H
#define GNPAPI_UPDATEAFFILIATEDTO_H
...
inline void UpdateAffiliateDto::fromJson(const Json::Value &json) {
...
#endif //GNPAPI_UPDATEAFFILIATEDTO_H