...
class ScheduledPublicationAccess
{
  public:
    struct Cols
    {
        static const std::string _id;
        static const std::string _user_subscription_id;
     ...
     */
    explicit ScheduledPublicationAccess(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ScheduledPublicationAccess(const Json::Value &pJson) noexcept(false);
     ...
     */
    ScheduledPublicationAccess(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    ScheduledPublicationAccess() = default;
    ...
    /**  For column user_subscription_id  */
    ///Get the value of the column user_subscription_id, returns the default value if the column is null
    const std::string &getValueOfUserSubscriptionId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getUserSubscriptionId() const noexcept;
    ///Set the value of the column user_subscription_id
    void setUserSubscriptionId(const std::string &pUserSubscriptionId) noexcept;
    void setUserSubscriptionId(std::string &&pUserSubscriptionId) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<ScheduledPublicationAccess>;
    friend drogon::orm::BaseBuilder<ScheduledPublicationAccess, true, true>;
    friend drogon::orm::BaseBuilder<ScheduledPublicationAccess, true, false>;
    friend drogon::orm::BaseBuilder<ScheduledPublicationAccess, false, true>;
    friend drogon::orm::BaseBuilder<ScheduledPublicationAccess, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<ScheduledPublicationAccess>;
#endif
    ...
    std::shared_ptr<std::string> userSubscriptionId_;
