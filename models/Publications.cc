...
const std::string Publications::Cols::_type = "\"type\"";
...
const int32_t &Publications::getValueOfType() const noexcept
{
...
const std::shared_ptr<int32_t> &Publications::getType() const noexcept
{
    return type_;
}
void Publications::setType(const int32_t &pType) noexcept
{
    type_ = std::make_shared<int32_t>(pType);
    dirtyFlag_[2] = true;
}
void Publications::setTypeToNull() noexcept
{
    type_.reset();
    dirtyFlag_[2] = true;
}
...
const std::string &Publications::getValueOfPrice() const noexcept
{
    static const std::string defaultValue = std::string();
    if(price_)
        return *price_;
...
const std::shared_ptr<std::string> &Publications::getPrice() const noexcept
{
    return price_;
}
void Publications::setPrice(const std::string &pPrice) noexcept
{
    price_ = std::make_shared<std::string>(pPrice);
    dirtyFlag_[7] = true;
}
void Publications::setPrice(std::string &&pPrice) noexcept
{
