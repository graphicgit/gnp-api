...
class PublicationReads
{
  public:
    struct Cols
    {
        ...
        static const std::string _read_at;
    };
     ...
     */
    explicit PublicationReads(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit PublicationReads(const Json::Value &pJson) noexcept(false);
     ...
     */
    PublicationReads(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    PublicationReads() = default;
    ...
    /**  For column read_at  */
    ///Get the value of the column read_at, returns the default value if the column is null
    const ::trantor::Date &getValueOfReadAt() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<::trantor::Date> &getReadAt() const noexcept;
    ///Set the value of the column read_at
    void setReadAt(const ::trantor::Date &pReadAt) noexcept;
  ...
  private:
    ...
    friend drogon::orm::BaseBuilder<PublicationReads, true, false>;
    friend drogon::orm::BaseBuilder<PublicationReads, false, true>;
    friend drogon::orm::BaseBuilder<PublicationReads, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<PublicationReads>;
#endif
    ...
    std::shared_ptr<::trantor::Date> readAt_;
    struct MetaData
    {
