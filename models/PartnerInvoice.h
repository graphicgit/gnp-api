...
class PartnerInvoice
{
  public:
     ...
     */
    explicit PartnerInvoice(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit PartnerInvoice(const Json::Value &pJson) noexcept(false);
     ...
     */
    PartnerInvoice(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    PartnerInvoice() = default;
  ...
  private:
    friend drogon::orm::Mapper<PartnerInvoice>;
    friend drogon::orm::BaseBuilder<PartnerInvoice, true, true>;
    friend drogon::orm::BaseBuilder<PartnerInvoice, true, false>;
    friend drogon::orm::BaseBuilder<PartnerInvoice, false, true>;
    friend drogon::orm::BaseBuilder<PartnerInvoice, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<PartnerInvoice>;
#endif
