...
class NewspaperDetails
{
  public:
     ...
     */
    explicit NewspaperDetails(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit NewspaperDetails(const Json::Value &pJson) noexcept(false);
     ...
     */
    NewspaperDetails(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    NewspaperDetails() = default;
  ...
  private:
    friend drogon::orm::Mapper<NewspaperDetails>;
    friend drogon::orm::BaseBuilder<NewspaperDetails, true, true>;
    friend drogon::orm::BaseBuilder<NewspaperDetails, true, false>;
    friend drogon::orm::BaseBuilder<NewspaperDetails, false, true>;
    friend drogon::orm::BaseBuilder<NewspaperDetails, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<NewspaperDetails>;
#endif
