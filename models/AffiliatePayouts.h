...
class AffiliatePayouts
{
  public:
     ...
     */
    explicit AffiliatePayouts(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit AffiliatePayouts(const Json::Value &pJson) noexcept(false);
     ...
     */
    AffiliatePayouts(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    AffiliatePayouts() = default;
  ...
  private:
    friend drogon::orm::Mapper<AffiliatePayouts>;
    friend drogon::orm::BaseBuilder<AffiliatePayouts, true, true>;
    friend drogon::orm::BaseBuilder<AffiliatePayouts, true, false>;
    friend drogon::orm::BaseBuilder<AffiliatePayouts, false, true>;
    friend drogon::orm::BaseBuilder<AffiliatePayouts, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<AffiliatePayouts>;
#endif
