...
public:
  ...
  drogon::Task<gnp::dto::BaseApiResponse>
  completeUserOneTimeBuyAsync(const std::string &userId,
                              const std::string &reference);

  drogon::Task<gnp::dto::BaseApiResponse>
  initializeUserOneTimeBuyAsync(const std::string &newsPaperId,
  ...
  drogon::Task<gnp::dto::BaseApiResponse> buyCopy(const std::string &userId, const dto::BuyNewspaperCopyDto &dto);

  drogon::Task<gnp::dto::BaseApiResponse>
  fulFillBuyCopy(const std::string &reference);
