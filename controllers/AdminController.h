...
public:
  ...
  ADD_METHOD_TO(AdminController::updateNewsPaper, PREFIX + "/update-newspaper", Post, Options);
  ADD_METHOD_TO(AdminController::deleteNewsPaper, PREFIX + "/delete-newspaper", Delete, Options);
  // users
  ADD_METHOD_TO(AdminController::getAllUsers, PREFIX + "/get-all-users", Get, Options);
  ADD_METHOD_TO(AdminController::getUserDetails, PREFIX + "/get-user-details", Get, Options);
  ADD_METHOD_TO(AdminController::lockUserAccount, PREFIX + "/lock-account", Get, Options);
  ADD_METHOD_TO(AdminController::unLockUserAccount, PREFIX + "/unlock-account", Get, Options);
  ADD_METHOD_TO(AdminController::activate, PREFIX + "/activate", Get, Options);
  ADD_METHOD_TO(AdminController::deactivate, PREFIX + "/deactivate", Get, Options);
  ...
  ADD_METHOD_TO(AdminController::updateUser, PREFIX + "/update-profile-image", Post, Options);
  ADD_METHOD_TO(AdminController::deleteUser, PREFIX + "/delete", Delete, Options);
  ...
  ADD_METHOD_TO(AdminController::deleteCampaign, PREFIX + "/delete-campaign", Get, Options);
    ...
    // commercial partners
  ADD_METHOD_TO(AdminController::getAllPartners, PREFIX + "/get-all-partners", Get, Options);
  ADD_METHOD_TO(AdminController::getPartnerSubscribers, PREFIX + "/get-partner-subscribers", Get, Options);
  ADD_METHOD_TO(AdminController::getPartnerStats, PREFIX + "/get-partner-stats", Get, Options);
  ADD_METHOD_TO(AdminController::getPartnerDetails, PREFIX + "/get-partner-details", Get, Options);
  ADD_METHOD_TO(AdminController::createPartner, PREFIX + "/create-partner", Post, Options);
  ADD_METHOD_TO(AdminController::createPartnerSubscriber, PREFIX + "/create-partner-subscriber", Post, Options);
  ADD_METHOD_TO(AdminController::assignPartnerSubscribersPlan, PREFIX + "/assign-partner-subscribers-plan", Post, Options);
  ADD_METHOD_TO(AdminController::updatePartner, PREFIX + "/update-partner",  Post, Options);
  ADD_METHOD_TO(AdminController::updatePartnerStatus, PREFIX + "/update-partner-status",  Get, Options);
  ADD_METHOD_TO(AdminController::deletePartner, PREFIX + "/delete-partner", Delete, Options);

    ADD_METHOD_TO(AdminController::enablePartnerSubaccount, PREFIX + "/enable-partner-subaccount",  Get, Options);

    ADD_METHOD_TO(AdminController::disablePartnerSubaccount, PREFIX + "/disable-partner-subaccount", Get, Options);
  ...
  // Newspapers
  void
  getAllNewsPapers(const HttpRequestPtr &req,std::function<void(const HttpResponsePtr &)> &&callback);
  ...
  void getPartnerSubscribers(const HttpRequestPtr &req,  std::function<void(const HttpResponsePtr &)> &&callback);
