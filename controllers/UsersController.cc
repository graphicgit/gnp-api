...
void UsersController::getUsers(const HttpRequestPtr& req, std::function<void (const HttpResponsePtr &)> &&callback)
{
    ...
    userService.getAll(pageNo, pageSize, query, [callback](const gnp::dto::BaseApiResponse& result) {
...
void UsersController::lockUserAccount(const HttpRequestPtr& req, std::function<void (const HttpResponsePtr &)> &&callback)
{
    ...
    userService.lockUserAccount(userId, [callback](const gnp::dto::BaseApiResponse& result) {
        auto resp = HttpResponse::newHttpJsonResponse(result.toJson());
        resp->setStatusCode(result.success ? k200OK : (result.error.isMember("code") &&
                                                     result.error["code"].asInt() == gnp::constants::ERR_RESOURCE_NOT_FOUND ?
...
void UsersController::unLockUserAccount(const HttpRequestPtr& req, std::function<void (const HttpResponsePtr &)> &&callback)
{
    ...
    // Call the service to lock the user account
    userService.unlockUserAccount(userId, [callback](const gnp::dto::BaseApiResponse& result) {
        auto resp = HttpResponse::newHttpJsonResponse(result.toJson());
        resp->setStatusCode(result.success ? k200OK : (result.error.isMember("code") &&
                                                     result.error["code"].asInt() == gnp::constants::ERR_RESOURCE_NOT_FOUND ?
                                                     k404NotFound : k500InternalServerError));
...
void UsersController::generateAuthToken(const HttpRequestPtr& req, std::function<void (const HttpResponsePtr &)> &&callback)
{
    ...
    userService.validateUserCredentials(signin_dto, [callback](const gnp::dto::BaseApiResponse& result) {
       auto resp = HttpResponse::newHttpJsonResponse(result.toJson());
...
void UsersController::activate(const HttpRequestPtr& req, std::function<void (const HttpResponsePtr &)> &&callback)
{
    // Extract user ID from the path parameters
    auto userId = req->getParameter("id");
    ...
    // Call the service to lock the user account
    userService.activateUserAccount(userId, [callback](const gnp::dto::BaseApiResponse& result) {
        auto resp = HttpResponse::newHttpJsonResponse(result.toJson());
        resp->setStatusCode(result.success ? k200OK : (result.error.isMember("code") &&
                                                     result.error["code"].asInt() == gnp::constants::ERR_RESOURCE_NOT_FOUND ?
                                                     k404NotFound : k500InternalServerError));
...
void UsersController::deactivate(const HttpRequestPtr& req, std::function<void (const HttpResponsePtr &)> &&callback)
{
    // Extract user ID from the path parameters
    auto userId = req->getParameter("id");
    ...
    // Call the service to lock the user account
    userService.deactivateUserAccount(userId, [callback](const gnp::dto::BaseApiResponse& result) {
        auto resp = HttpResponse::newHttpJsonResponse(result.toJson());
        resp->setStatusCode(result.success ? k200OK : (result.error.isMember("code") &&
                                                     result.error["code"].asInt() == gnp::constants::ERR_RESOURCE_NOT_FOUND ?
                                                     k404NotFound : k500InternalServerError));
...
void UsersController::deleteUser(const HttpRequestPtr& req, std::function<void (const HttpResponsePtr &)> &&callback)
{
    ...
    // Call the service to lock the user account
    userService.deleteUser(userId, [callback](const gnp::dto::BaseApiResponse& result) {
        auto resp = HttpResponse::newHttpJsonResponse(result.toJson());
        resp->setStatusCode(result.success ? k200OK : (result.error.isMember("code") &&
                                                     result.error["code"].asInt() == gnp::constants::ERR_RESOURCE_NOT_FOUND ?
                                                     k404NotFound : k500InternalServerError));
