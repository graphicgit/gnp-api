...
class ReportsController : public drogon::HttpController<ReportsController>
{
  ...
  METHOD_LIST_BEGIN
    ...
    ADD_METHOD_TO(ReportsController::sendPartnerInvoiceEmail, std::string(PREFIX) + "send-partner-invoice-email", Post, Options, "JwtAuthFilter");
  ...
  drogon::Task<HttpResponsePtr> sendPartnerInvoiceEmail(HttpRequestPtr req);
